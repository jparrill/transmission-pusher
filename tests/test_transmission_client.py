...
class TestTransmissionClient:
    ...
    def test_get_session_id_no_session_id(self, client, mock_session):
    ...
    def test_add_torrent_file_file_not_found(self, client):
    ...
    def test_add_torrent_url_success(self, client, mock_session):
    ...
    def test_add_torrent_url_api_error(self, client, mock_session):
    ...
    def test_get_torrents_success(self, client, mock_session):
    ...
    def test_get_torrents_empty(self, client, mock_session):
    ...
    def test_get_torrents_connection_error(self, client, mock_session):
